...
| 15 | newforms-and-level | Oldforms, degeneracy maps, Atkin–Lehner, **newforms** as the honest basis, the level | Discharges L12. Without this, "the level" in Ribet's theorem is undefined. **Boundary:** essay 14 imports Petersson self-adjointness only for $(n,N)=1$; do not let the bad-prime operators inherit its spectral-theorem conclusion for free. If Atkin–Lehner theory needs a second analytic input to control them, name and register that import as explicitly as 14 names the first. |
