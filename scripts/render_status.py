...
def render_block(items: list[dict], policy: dict, revisions: list[dict], upto: str = "HEAD") -> str:  # noqa: C901
    ...
    lines = [
        ...
        *render_items(proved, items),
        "",
        "   <h3>Stated with hypotheses, not proved here</h3>",
        '    <p class="scope-note">This list is generated from the available stated records named in',
        "     the completion policy; it is not maintained by hand. Each item closes a dependency",
